contract EnergyOfTransferFailedTest {
    ...
    function testCallCypInsufficientBalance(uint256 i,address payable caller) public {
    ...
    function testSendCypNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
    }

    function testSendCypRevert(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.send(i);
        revert();
    }

    function testTransferCypNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
        nonexistentTarget.transfer(i);
    }

    function testTransferCyprevert(uint256 i,address payable nonexistentTarget) payable public{
        nonexistentTarget.transfer(i);
        revert();
    }
    ...
    function testCallCypNonexistentTarget(uint256 i,address payable nonexistentTarget) payable public {
